...
def Init():
    ...
    for i in range(berth_num):
        ...
        logger.debug("time: %d, velocity: %d,",berth[id].transport_time, berth[id].loading_speed)
    boat_capacity = int(input())
    logger.debug(msg=boat_capacity)
    okk = input()
    print("OK")
    sys.stdout.flush()
...
if __name__ == "__main__":
    ...
    fh = logging.FileHandler('spam1.log', mode="w")
